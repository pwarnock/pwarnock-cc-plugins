---
name: no-use-effect
description: "Ban useEffect in React components — enforce derived state, event handlers, data-fetching hooks, key resets, and useMountEffect instead."
version: 1.0.0
author: Alvin Ng
source: https://gist.github.com/alvinsng/5dd68c6ece355dbdbd65340ec2927b1d
---

# No useEffect

> **Attribution:** This skill was authored by [Alvin Ng](https://x.com/alvinsng) and is curated here with credit. [Original gist](https://gist.github.com/alvinsng/5dd68c6ece355dbdbd65340ec2927b1d) | [Original tweet](https://x.com/alvinsng/status/2033969062834045089).
